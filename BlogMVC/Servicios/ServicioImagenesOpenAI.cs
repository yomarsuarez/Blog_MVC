    ...
    public class ServicioImagenesOpenAI : IServicioImagenes
    {
        ...
        public async Task<byte[]> GenerarPortadaEntrada(string titulo)
        {
            string prompt = $"""
                ...
                Si el tema trata sobre programación en general, mostrar a un programador concentrado frente a una computadora con el
                çódigo en pantalla. Si el tema esta relacionado con base de datos, representar un servidor o una visualización de datos
                en una pantalla holográfica. Si se trata sobre inteligencia artificial, mostar un entorno futurista con redes neuronales
                y digitales. La iluminación debe ser natural y realista, con una profundidad de campo bien definida. La imagen debe ser
                moderna y tecnológica, evitando clichés exagerados como fondos de neón con código flotante en el aire.
                """;
