...
namespace BlogMVC.Servicios
{
    ...
    public class ServicioUsuarios : IServicioUsuarios
    {
        ...
        private static readonly string[] RolesCRUDEntradas = { Constantes.CRUDEntradas, Constantes.RolAdmin };
        private static readonly string[] RolesBorrarComentarios = { Constantes.BorraCometarios, Constantes.RolAdmin };
